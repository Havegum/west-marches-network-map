...
// We can't import this directly beacause the rollup pluginutils also
// need node modules like `fs`, which  isn't available in snowpack.
const reservedWords =
...
module.exports = function makeLegalIdentifier (str) {
  let identifier = str
